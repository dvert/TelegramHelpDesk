...
$('body').on('click', 'button#action_refer_to', function (event) {
    ...
    $('body').on('click', 'button#action_change_prio', function (event) {
        event.preventDefault();
        var st = $("#action_change_prio").attr('value');


        if (st == '0') {
            $("#change_prio").fadeIn(500);
            $(this).addClass('active').attr('value', '1');
        }
        if (st == '1') {
            $("#change_prio").fadeOut(500);
            $(this).removeClass('active').attr('value', '0');
        }
...
$('a#edit_deps').each(function(i, e) {
    ...
    $('body').on('click', 'button#action_ok', function(event) {
        ...
        if (status_lock == 'ok') {
            ...
            $("button#action_change_prio").removeAttr('disabled');
            $.ajax({
                type: "POST",
                url: ACTIONPATH,
                data: "mode=status_ok"+
        ...
        if (status_lock == 'no_ok') {
            ...
            $("button#action_change_prio").attr('disabled', "disabled");
...
if( $("#users_do").val() != '' ) {
    ...
    */
    ...
    $('#fileupload').fileupload({
        ...
        url: MyHOSTNAME+'AppTask/NewTask',
        autoUpload: true,
